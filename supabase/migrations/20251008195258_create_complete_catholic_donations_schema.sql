/*
  ...
  - `pagarme_public_key` (text) - Chave pública Pagar.me
  - `pagarme_secret_key` (text) - Chave secreta Pagar.me
  - `pagarme_webhook_id` (text) - ID do webhook
  - `pagarme_configured` (boolean) - Status da configuração
...
CREATE TABLE IF NOT EXISTS parishes (
  ...
  pagarme_webhook_id text,
  pagarme_configured boolean DEFAULT false,
...
CREATE POLICY "Parish admins can insert own parish"
